...
import type { SupabaseClientOptions } from "./lib/types.js";
export * from "@supabase/auth-js";
export type { User as AuthUser, Session as AuthSession } from "@supabase/auth-js";
export type { PostgrestResponse, PostgrestSingleResponse, PostgrestMaybeSingleResponse } from "@supabase/postgrest-js";
export { PostgrestError } from "@supabase/postgrest-js";
export type { FunctionInvokeOptions } from "@jsr/supabase__functions-js";
export { FunctionsHttpError, FunctionsFetchError, FunctionsRelayError, FunctionsError, FunctionRegion } from "@jsr/supabase__functions-js";
export * from "@supabase/realtime-js";
export { default as SupabaseClient } from "./SupabaseClient.js";
export type { SupabaseClientOptions, QueryResult, QueryData, QueryError, DatabaseWithoutInternals } from "./lib/types.js";
/**
